...
@Component({
  selector: 'app-actividad-parametrizable',
  templateUrl: './actividad-parametrizable.component.html',
  styleUrls: ['./actividad-parametrizable.component.css']
})
export class ActividadParametrizableComponent implements OnInit {
  ...
  constructor(
    public actividadParametricaService: ActividadParametrizableService
  ) {
    this.inicio();
  }
  //#endregion
  ...
  save() {
    ...
    this.actividadParametricaService.addActividadParametrica(act).subscribe(data => {
      console.log(data);
    });
  }
  //#endregion
