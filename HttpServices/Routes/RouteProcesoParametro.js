...
var routeExample = require('../Models/ModeloProcesoParametro'); //copiar el modelo de la tabla
...
routeExample.register(router, '/proceso_parametro'); //nombre ruta para acceder por web
