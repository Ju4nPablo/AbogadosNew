...
var routeExample = require('../Models/ModeloResponsable'); //copiar el modelo de la tabla
...
routeExample.register(router, '/responsable'); //nombre ruta para acceder por web
