...
var routeExample = require('../Models/ModeloActividadParametro'); //copiar el modelo de la tabla
...
routeExample.register(router, '/actividad_parametro'); //nombre ruta para acceder por web
