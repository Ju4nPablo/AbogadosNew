...
var routeExample = require('../Models/ModeloFlujoProceso'); //copiar el modelo de la tabla
...
routeExample.register(router, '/flujo_proceso'); //nombre ruta para acceder por web
